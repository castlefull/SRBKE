...
# 동영상 파일 열기
video_path = r"C:\Users\windows11\Downloads\Bromobenzene _ Organic Synthesis - Trim.mp4"  # 입력 동영상 파일 경로
cap = cv2.VideoCapture(video_path)

# 비디오 저장 설정
fourcc = cv2.VideoWriter_fourcc(*'mp4v')  # MP4 코덱 설정
out = cv2.VideoWriter('detected_output.mp4', fourcc, cap.get(cv2.CAP_PROP_FPS), 
